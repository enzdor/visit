...
export default function Navigation(){
	...
	return(
		...
		{ open
			...
			<AnimatedBox style={spring} sx={{zIndex: '2', width: '100vw', height: '100vh', position: 'absolute', top: '0', left: '0', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(235, 245, 233, 0.95)'}}>
				<Grid container>
